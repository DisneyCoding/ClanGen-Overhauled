...
class Sprites:
    ...
    def load_tints(self):
        ...
        try:
            with open(
                "sprites/dicts/dark_patches_tint.json", "r", encoding="utf-8"
            ) as read_file:
                self.dark_patches_tints = ujson.loads(read_file.read())
        except IOError:
            print("ERROR: Reading Dark Patches Tints")
    ...
    def make_group(
        self, spritesheet, pos, name, sprites_x=6, sprites_y=7, no_index=False
